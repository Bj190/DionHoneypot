...
honeypot_handler = RotatingFileHandler(terminal_Honeypot_log_local_file_path, maxBytes=10000, backupCount=5)
...
creds_handler = RotatingFileHandler(creds_logger_log_local_file_path, maxBytes=10000, backupCount=5)
