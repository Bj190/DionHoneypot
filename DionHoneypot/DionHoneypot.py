        ...
        try:
            ...
            while run:
                ...
                while not command.endswith("\r"):
                    ...
                    print(client_ip+"- received:",transport) #debug
                    ...
                    if(
                        ...
                        command += transport.decode("utf-8") #This takes in and adds the input from client to the command each time
                ...
                if command == "exit":
                    ...
                    handle_command(command, channel, current_directory, file_structure, client_ip, current_user)
...
def handle_command(command, channel, current_directory, file_structure, client_ip, current_user):
    ...
    while True:
        ...
        honeypot_logger.info(f"Bad Actor Input: {command}, Location: {client_ip}: {command.decode()}")
