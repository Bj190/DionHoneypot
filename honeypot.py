...
class Server(paramiko.ServerInterface):
    ...
    def check_channel_request(self,kind:str, chanid: id) -> int:
        if kind == 'session':
            return paramiko.OPEN_SUCCEEDED #check this?
    ...
    def check_auth_password(self, username, password):
        ...
        creds_logger.info(f'Client {self.client_ip}, {username}, {password}')
    ...
    #No clue what these two do. Tutorial not help
...
def client_handle(client, addr, username, password):
        ...
        try:
            ...
            standard_banner = "New session established!\r\n\r\n"
...
def honeypot(address, port, username, password):
    ...
    socks.listen(100) #sets connections limit
